...
- Refinamento visual das telas Web em 2026-08-18: `components/uiverse/navigation/web-screen-hero.tsx` e sua variante Web centralizam wallpaper, `Grainient`, título `StrokeText` e entrada animada das ilustrações SVG nas nove telas convertidas. Android/iOS continuam usando o fallback nativo do mesmo componente; a borda externa adicionada à superfície dos formulários foi removida. Vault alinhado em [[Versão Web]] e [[Componentes UI]].
- Atualizado em 2026-08-18.
