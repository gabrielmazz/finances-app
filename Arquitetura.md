...
- Timeline de movimentações bancárias Web em 2026-09-24: `BankMovementsScreen.web.tsx` agora usa a hierarquia e os contratos da timeline compartilhada com despesas obrigatórias e investimentos: trilho, ícone, identidade, valor/data à direita e detalhes expansíveis com `AnimatedContent`/`Grainient`. Paletas por tipo, filtros, metadados e ações financeiras foram mantidos; a composição mobile não mudou. Validações desta alteração serão registradas em [[Auditoria de Design]].
