...
- Refinamento visual das Tabs da análise por categoria na Web em 2026-09-02: `CategoryAnalysisScreen.web.tsx` mantém `Tabs` controladas do Mantine em um controle segmentado sem bordas externas ou nos gatilhos, com variável de cor explícita para impedir o azul primário padrão do Mantine, amarelo âmbar escuro `#CA8A04` da paleta do sistema no estado ativo, rótulos na fonte padrão do sistema e centralizados em cada tab, texto/ícone brancos quando selecionados, hover/foco visíveis e desabilitação contextual. **Gastos** e **Ganhos** continuam em ordem fixa no primeiro bloco visual, com o seletor de categorias imediatamente abaixo; estados, relatórios carregados, privacidade e a composição nativa com `components/ui/tabs` permanecem inalterados. Vault alinhado em [[Análise por Categoria]], [[Componentes UI]] e [[Versão Web]].
