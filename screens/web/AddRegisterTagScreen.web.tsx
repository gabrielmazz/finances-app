								...
								<VStack className="mt-4 gap-4 web:w-full web:max-w-[1180px] web:self-center web:rounded-[28px] web:p-8">
									...
									{!isEditing && !activeCreationPreset ? (
										...
										<>
											...
											<VStack>
												<Text className={`${webExpenseClassNames.fieldLabel} ${bodyText}`}>Nome da categoria</Text>
											...
											<VStack>
												<Text className={`${webExpenseClassNames.fieldLabel} ${bodyText}`}>Ícone da categoria</Text>
												<Pressable
