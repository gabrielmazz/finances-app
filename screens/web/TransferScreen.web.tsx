			...
			<View className="flex-1 web:w-screen" style={{ backgroundColor: surfaceBackground }}>
				...
				>
					<View className="flex-1 web:w-screen" style={{ backgroundColor: surfaceBackground }}>
						...
						>
							<VStack className={`${webDashboardClassNames.contentFrame} ${webDashboardClassNames.contentPadding} h-full mt-4`}>
								...
								<HStack className="w-full web:flex-wrap" space="md">
									...
									<VStack className="mb-4 flex-1 web:min-w-[280px]">
										<Text className={`${webExpenseClassNames.fieldLabel} ${bodyText}`}>Banco de destino</Text>
										<BankActionsheetSelector
								...
								<VStack className="mb-4">
									...
									<Input className={`${fieldContainerClassName} ${webExpenseClassNames.fieldInput}`} isDisabled={isTransferValueDisabled}>
										<InputField
								...
								<VStack className="mb-4">
									<Text className={`${webExpenseClassNames.fieldLabel} ${bodyText}`}>Data da transferência</Text>
									<DatePickerField
										value={transferDate}
								...
								<VStack className="mb-4">
									<Text className={`${webExpenseClassNames.fieldLabel} ${bodyText}`}>Descrição (opcional)</Text>
									<Textarea
