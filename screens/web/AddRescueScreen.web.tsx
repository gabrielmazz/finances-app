						...
						>
							<VStack className="justify-between mt-4 web:w-full web:max-w-[1180px] web:self-center web:rounded-[28px] web:p-8">
								...
								<VStack className="mb-4">
									...
									<Input className={`${fieldContainerClassName} ${webExpenseClassNames.fieldInput}`} isDisabled={isRescueValueDisabled}>
										<InputField
								...
								<VStack className="mb-4">
									<Text className={`${webExpenseClassNames.fieldLabel} ${bodyText}`}>Data do saque</Text>
									<DatePickerField
										value={rescueDate}
								...
								<VStack className="mb-4">
									<Text className={`${webExpenseClassNames.fieldLabel} ${bodyText}`}>Observações</Text>
									<Textarea className={`${textareaContainerClassName} ${webExpenseClassNames.fieldTextarea}`} isDisabled={isRescueDescriptionDisabled}>
										<TextareaInput
