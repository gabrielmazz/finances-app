...
- `screens/mobile/ScreenSettingsScreen.tsx` / `screens/web/ScreenSettingsScreen.web.tsx` — UI de configuração por tela, independente por plataforma.
- `app/mobile/screen-settings.tsx` / `app/web/screen-settings.tsx` — Rotas Expo Router da tela.
