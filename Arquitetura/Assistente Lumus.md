...
- `screens/mobile/LumusAssistantScreen.tsx` e `app/mobile/lumus-assistant.tsx` — chat e rota com montagem direta; o painel da tela informa a preparação assíncrona sem bloquear a navegação.
